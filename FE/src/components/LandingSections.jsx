...
function LandingSections({ stats, statsLoading, statsError, onNavigate }) {
  const statItems = stats ? [[`${stats.totalUsers || 0}`, 'người đang trồng'], [stats.availablePlots || 0, 'ô đất đang sẵn sàng'], [`${stats.greenAreaHa || 0} ha`, 'không gian xanh']] : [['—', 'người đang trồng'], ['—', 'ô đất đang sẵn sàng'], ['—', 'không gian xanh']]
  return <>
