...
router.get('/requests/consultations', admin.consultationRequests);
router.get('/services', admin.serviceRequests);
router.get('/complaints', admin.complaintRequests);
router.get('/consultations', admin.consultationRequests);
